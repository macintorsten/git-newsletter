...
- Do not start the document with `---`.
...
Before persisting output, validate the first non-empty line is not `---`. If it is,
rewrite the newsletter into the content-only format above.
